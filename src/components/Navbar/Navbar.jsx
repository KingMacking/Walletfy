        ...
        <header className="bg-white">
            <nav className={`flex md:justify-around justify-center items-center w-full sticky border-b-primary border-b-2 md:px-7 px-5 h-auto`}>
                <div className=" z-50 md:w-auto w-full flex justify-between items-center p-5">
                    <Link to="/home"><img src={logoNavbar} alt="Logo walletfy"></img></Link>
                ...
                <div className='md:flex hidden items-center justify-self-end gap-1'>
                    <Link className='border-[1.5px] border-transparent hover:border-primary rounded-full px-5 py-2 transition-all ease-in-out font-text'>Iniciar sesión</Link>
                    <Link className='bg-primary text-white px-5 py-2 rounded-full hover:bg-primary-interact transition-all ease-in-out font-text'>Registrarse</Link>
                </div>
                ...
                <ul className={`md:hidden fixed w-full top-0 overflow-y-auto bottom-0 gap-8 list-none py-24 bg-white pl-4 duration-200 ${open ? "left-0" : "left-[-100%]" }`}>
                    ...
                    <div className='flex items-center justify-self-end gap-3 mt-12'>
                        <Link className='border-[1.5px] border-transparent hover:border-primary rounded-full px-5 py-2 transition-all ease-in-out duration-100'>Iniciar sesión</Link>
                        <Link className='bg-primary text-white px-5 py-2 rounded-full hover:bg-primary-interact transition-all ease-in-out'>Registrarse</Link>
                    </div>
                </ul>
            </nav>
        </header>
