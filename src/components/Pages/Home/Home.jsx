...
const Home = () => {
    return (
        <div className='px-15 py-12 bg-white'>
            <div className='flex flex-col items-center justify-center gap-12 py-10 lg:flex-row lg:items-start'>
                ...
                <div className='flex flex-col w-4/5 lg:w-[50%] xl:w-[40%] mt-20 lg:mt-14 xl:mt-30'>
                    ...
                    <Link className='bg-primary text-white px-8 py-3 rounded-full font-title transition-all ease-in-out w-72 self-center text-center text-4xl lg:self-start hover:bg-primary-interact'>COMENZAR</Link>
                </div>
            </div>
        </div>
    )
