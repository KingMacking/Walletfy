...
const Login = () => {
    ...
    return (
        <div className="h-full py-10">
            ...
            <form className="bg-base flex flex-col px-5 py-8 mx-auto h-auto my-12 border border-primary rounded-2xl w-[300px] sm:w-[350px] md:w-[400px]" onSubmit={handleSubmit(submitLogin)}>
                {/*Email input*/}
