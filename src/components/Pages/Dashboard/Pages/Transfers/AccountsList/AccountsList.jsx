    ...
    return (
        <div className="p-6 w-full">
            <ul className="p-4 sm:p-8 bg-[#ffffff] shadow-lg rounded-xl w-full">
                ...
                <li className="flex items-center justify-between border-b border-primary-interact last:border-b-0 py-2">
                    ...
                    <div className="w-[2.1rem] md:w-28 font-text text-sm md:text-lg text-end font-bold">Tipo</div>
                </li>
                {accounts?.length > 0 ? 
