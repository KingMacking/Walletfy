...
const Activity = ({activity}) => {
    return (
        <div className="flex flex-col gap-1 border-b border-primary-interact py-4 last:border-b-0 px-2">
            <h4 className="font-title text-xl flex gap-2 items-center font-bold"><Icon className="rounded-full border bg-primary text-white p-1 text-4xl" icon={activity.typeIcon} inline={true} />{accountTypeName(activity.typeName)}</h4>
