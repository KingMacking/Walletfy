...
const ActivitiesBar = () => {
    ...
    return (
        <>
            <div className="hidden lg:flex lg:flex-col bg-real-white dark:bg-black dark:text-white min-w-[20rem] px-4 shadow-[-15px_0_10px_-6px_rgba(0,0,0,0.1)] h-screen fixed right-0">
            ...
            {/* Mobile activities */}
            <div className={`lg:hidden flex flex-col fixed h-screen bg-real-white dark:bg-black dark:text-white shadow-[-15px_0_10px_-6px_rgba(0,0,0,0.1)] w-80 px-4 duration-500  ${open ? "-right-0" : "-right-[19rem]"}`}>
