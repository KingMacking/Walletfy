        ...
        <div className="p-6 w-full">
            {
                ...
                <ul className="p-4 sm:p-8 gap-4 bg-real-white dark:bg-black dark:text-white shadow-lg rounded-xl w-full">
                    ...
                    <li className="flex items-center gap-4 justify-between border-b border-primary-interact last:border-b-0 py-2">
                        <div className="w-[4.65rem] md:w-40 font-text text-[10px] md:text-lg font-bold">Nombre</div>
                        <div className="w-[4rem] md:w-40 font-text text-[10px] md:text-lg font-bold">Balance</div>
                        <div className={`w-[1.5rem] md:w-28 font-text text-[10px] md:text-lg ${canDelete ? "text-center" : "text-end"} font-bold`}>Tipo</div>
                        {canDelete && <div className="w-[2.3rem] md:w-28 font-text text-[10px] md:text-lg text-end font-bold">Eliminar</div>}
                    </li>
                    {accounts?.length > 0 ? 
