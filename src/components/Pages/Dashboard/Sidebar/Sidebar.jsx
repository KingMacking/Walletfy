    ...
    return (
        <div className={`bg-primary min-h-full  ${open ? "w-80" : 'w-20'} text-white px-4 duration-500 -left-16 ${open && "-left-0"} sm:-left-0 fixed`}>
            ...
            <div className='mt-4 flex flex-col gap-4'>
                ...
                <NavLink className={({isActive}) => [`border border-primary flex items-center gap-3 font-text p-2 hover:bg-primary-interact rounded-md transition-all ease-in-out ${!open && "w-fit"} mt-4`, isActive && "border border-primary-interact"].join(" ") } to="/dashboard/main"><div><Icon className='text-3xl' icon="material-symbols:dashboard" inline={true} /></div><h2 className={`font-title text-lg whitespace-pre duration-500 ${!open && 'hidden translate-x-28 overflow-hidden'}`}>Dashboard</h2></NavLink>
                <NavLink className={({isActive}) => [`border border-primary flex items-center ${!open && "w-fit"} gap-3 font-text p-2 hover:bg-primary-interact rounded-md transition-all ease-in-out`, isActive && "border border-primary-interact"].join(" ") } to="/dashboard/profile"><div><Icon className='text-3xl' icon="mdi:user" inline={true} /></div><h2 className={`font-title text-lg whitespace-pre duration-500 ${!open && 'hidden translate-x-28 overflow-hidden'}`}>Perfil</h2></NavLink>
                <NavLink className={({isActive}) => [`border border-primary flex items-center ${!open && "w-fit"} gap-3 font-text p-2 hover:bg-primary-interact rounded-md transition-all ease-in-out mb-4`, isActive && "border border-primary-interact"].join(" ") } to="/dashboard/accounts"><div><Icon className='text-3xl'  icon="material-symbols:account-balance-wallet-outline-rounded" inline={true} /></div><h2 className={`font-title text-lg whitespace-pre duration-500 ${!open && 'hidden translate-x-28 overflow-hidden'}`}>Cuentas</h2></NavLink>
                <div className='h-[2px] bg-primary-interact'></div>
                <NavLink className={({isActive}) => [`border border-primary flex items-center gap-3 font-text p-2 hover:bg-primary-interact rounded-md transition-all ease-in-out ${!open && "w-fit"} mt-4`, isActive && "border border-primary-interact"].join(" ") } to="/dashboard/incomes"><div><Icon className='text-3xl' icon="majesticons:money-plus-line" inline={true} /></div><h2 className={`font-title text-lg whitespace-pre duration-500 ${!open && 'hidden translate-x-28 overflow-hidden'}`}>Ingresos</h2></NavLink>
                <NavLink className={({isActive}) => [`border border-primary flex items-center ${!open && "w-fit"} gap-3 font-text p-2 hover:bg-primary-interact rounded-md transition-all ease-in-out`, isActive && "border border-primary-interact"].join(" ") } to="/dashboard/payments"><div><Icon className='text-3xl' icon="majesticons:money-minus-line" inline={true} /></div><h2 className={`font-title text-lg whitespace-pre duration-500 ${!open && 'hidden translate-x-28 overflow-hidden'}`}>Pagos</h2></NavLink>
                ...
                <div className='h-[2px] bg-primary-interact'></div>
                <NavLink className={({isActive}) => [`border border-primary flex items-center gap-3 font-text p-2 hover:bg-primary-interact rounded-md transition-all ease-in-out ${!open && "w-fit"} mt-4`, isActive && "border border-primary-interact"].join(" ") } to="/dashboard/configuration"><div><Icon className='text-3xl' icon="material-symbols:settings-rounded" inline={true} /></div><h2 className={`font-title text-lg whitespace-pre duration-500 ${!open && 'hidden translate-x-28 overflow-hidden'}`}>Configuración</h2></NavLink>
